...
;
;
const Text = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(({ sdfGlyphSize = 64, anchorX = 'center', anchorY = 'middle', font, fontSize = 1, children, characters, onSync, ...props }, ref)=>{
    const invalidate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$dc44c1b8$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__A__as__useThree$3e$__["useThree"])({
        "Text.useThree[invalidate]": ({ invalidate })=>invalidate
    }["Text.useThree[invalidate]"]);
    const [troikaMesh] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
    ...
    const [nodes, text] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Text.useMemo": ()=>{
            const n = [];
            let t = '';
...
"[project]/node_modules/@react-three/drei/core/TransformControls.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2d$stdlib$2f$controls$2f$TransformControls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three-stdlib/controls/TransformControls.js [app-client] (ecmascript)");
;
;
;
;
;
const TransformControls = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(({ children, domElement, onChange, onMouseDown, onMouseUp, onObjectChange, object, makeDefault, camera, // Transform
enabled, axis, mode, translationSnap, rotationSnap, scaleSnap, space, size, showX, showY, showZ, ...props }, ref)=>{
    const defaultControls = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$dc44c1b8$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__A__as__useThree$3e$__["useThree"])({
        "TransformControls.useThree[defaultControls]": (state)=>state.controls
    }["TransformControls.useThree[defaultControls]"]);
    const gl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$dc44c1b8$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__A__as__useThree$3e$__["useThree"])({
        "TransformControls.useThree[gl]": (state)=>state.gl
    }["TransformControls.useThree[gl]"]);
    const events = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$dc44c1b8$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__A__as__useThree$3e$__["useThree"])({
        "TransformControls.useThree[events]": (state)=>state.events
    }["TransformControls.useThree[events]"]);
    const defaultCamera = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$dc44c1b8$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__A__as__useThree$3e$__["useThree"])({
        "TransformControls.useThree[defaultCamera]": (state)=>state.camera
    }["TransformControls.useThree[defaultCamera]"]);
    const invalidate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$dc44c1b8$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__A__as__useThree$3e$__["useThree"])({
        "TransformControls.useThree[invalidate]": (state)=>state.invalidate
    }["TransformControls.useThree[invalidate]"]);
    const get = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$dc44c1b8$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__A__as__useThree$3e$__["useThree"])({
        "TransformControls.useThree[get]": (state)=>state.get
    }["TransformControls.useThree[get]"]);
    const set = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$fiber$2f$dist$2f$events$2d$dc44c1b8$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__A__as__useThree$3e$__["useThree"])({
        "TransformControls.useThree[set]": (state)=>state.set
    }["TransformControls.useThree[set]"]);
    const explCamera = camera || defaultCamera;
    const explDomElement = domElement || events.connected || gl.domElement;
    const controls = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TransformControls.useMemo[controls]": ()=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2d$stdlib$2f$controls$2f$TransformControls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TransformControls"](explCamera, explDomElement)
    }["TransformControls.useMemo[controls]"], [
        explCamera,
        explDomElement
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "TransformControls.useLayoutEffect": ()=>{
            if (object) {
                controls.attach(object instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Object3D"] ? object : object.current);
            } else if (group.current instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Object3D"]) {
                controls.attach(group.current);
            }
            return ({
                "TransformControls.useLayoutEffect": ()=>void controls.detach()
            })["TransformControls.useLayoutEffect"];
        }
    }["TransformControls.useLayoutEffect"], [
        object,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransformControls.useEffect": ()=>{
            if (defaultControls) {
                const callback = {
                    "TransformControls.useEffect.callback": (event)=>defaultControls.enabled = !event.value
                }["TransformControls.useEffect.callback"];
                controls.addEventListener('dragging-changed', callback);
                return ({
                    "TransformControls.useEffect": ()=>controls.removeEventListener('dragging-changed', callback)
                })["TransformControls.useEffect"];
            }
        }
    }["TransformControls.useEffect"], [
    ...
    const onChangeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    const onMouseDownRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    const onMouseUpRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    const onObjectChangeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "TransformControls.useLayoutEffect": ()=>void (onChangeRef.current = onChange)
    }["TransformControls.useLayoutEffect"], [
        onChange
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "TransformControls.useLayoutEffect": ()=>void (onMouseDownRef.current = onMouseDown)
    }["TransformControls.useLayoutEffect"], [
        onMouseDown
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "TransformControls.useLayoutEffect": ()=>void (onMouseUpRef.current = onMouseUp)
    }["TransformControls.useLayoutEffect"], [
        onMouseUp
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "TransformControls.useLayoutEffect": ()=>void (onObjectChangeRef.current = onObjectChange)
    }["TransformControls.useLayoutEffect"], [
        onObjectChange
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransformControls.useEffect": ()=>{
            const onChange = {
                "TransformControls.useEffect.onChange": (e)=>{
                    invalidate();
                    onChangeRef.current == null || onChangeRef.current(e);
                }
            }["TransformControls.useEffect.onChange"];
            const onMouseDown = {
                "TransformControls.useEffect.onMouseDown": (e)=>onMouseDownRef.current == null ? void 0 : onMouseDownRef.current(e)
            }["TransformControls.useEffect.onMouseDown"];
            const onMouseUp = {
                "TransformControls.useEffect.onMouseUp": (e)=>onMouseUpRef.current == null ? void 0 : onMouseUpRef.current(e)
            }["TransformControls.useEffect.onMouseUp"];
            const onObjectChange = {
                "TransformControls.useEffect.onObjectChange": (e)=>onObjectChangeRef.current == null ? void 0 : onObjectChangeRef.current(e)
            }["TransformControls.useEffect.onObjectChange"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransformControls.useEffect": ()=>{
            if (makeDefault) {
                ...
                return ({
                    "TransformControls.useEffect": ()=>set({
                            controls: old
                        })
                })["TransformControls.useEffect"];
            }
...
//# sourceMappingURL=node_modules_1e5f2f3e._.js.map